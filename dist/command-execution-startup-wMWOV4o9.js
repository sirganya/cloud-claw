...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-D_yCjDei.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-CZpeC0Jt.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-7JWfv1P3.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-Bt-ufw2Z.js");
	if (params.argv) {
