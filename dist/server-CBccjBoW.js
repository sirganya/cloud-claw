...
import { m as resolveUserPath, s as ensureDir } from "./utils-D2Wwrmfu.js";
...
import { a as isA2uiPath, i as injectCanvasLiveReload, n as CANVAS_HOST_PATH } from "./a2ui-shared-BkPCRqYd.js";
import { n as normalizeUrlPath, r as resolveFileWithinRoot } from "./a2ui-B0-zrrw_.js";
	...
	const server = http.createServer((req, res) => {
		...
		(async () => {
			if (req.url && isA2uiPath(new URL(req.url, "http://localhost").pathname)) {
				const { handleA2uiHttpRequest } = await import("./a2ui-Dqetbwaj.js");
