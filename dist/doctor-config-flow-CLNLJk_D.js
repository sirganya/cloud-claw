...
import { h as parseLegacySecretRefEnvMarker, i as LEGACY_SECRETREF_ENV_MARKER_PREFIX } from "./types.secrets-B_tDs-aP.js";
...
import { R as resolveNormalizedProviderModelMaxTokens } from "./io-BRLT3T3n.js";
import { _ as collectConfiguredModelRefs } from "./gateway-startup-speech-providers-BKasnhDL.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-BIKs-96s.js";
import { r as getBundledChannelPlugin, s as hasBundledChannelPackageSetupFeature } from "./bundled-DyWCi3My.js";
import { n as formatConfigIssueLines } from "./issue-format-RCKTtsD6.js";
import { r as normalizeTalkSection } from "./talk-VyxCh7dv.js";
import { c as callGateway } from "./call-BJmsXbuv.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-OyI5UQr_.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-Bh6aZpip.js";
import { a as legacyRuntimeModelAliasRequiresRuntimePolicy, i as migrateLegacyXSearchConfig, o as listLegacyRuntimeModelProviderAliases, r as migrateLegacyWebSearchConfig, s as migrateLegacyRuntimeModelRef } from "./legacy-config-migrations-BUKqq11u.js";
import { c as mergeMissing, r as isLegacyModelsAddCodexMetadataModel } from "./legacy-config-migrations.runtime.models-BsIWnXZ3.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-DcWzcWTV.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-BUsGM899.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-D8AZ16Xw.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-DKvEOxVR.js");
	...
	const { collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-uZxqKQZK.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-ZLCYgvkL.js");
	...
	const { repairHooksTokenReuseGatewayAuth } = await import("./hooks-token-reuse-repair-PvD6t7FX.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-DIIFTvr1.js");
		...
		const { collectDoctorPreviewNotes } = await import("./preview-warnings-CfXLPN64.js");
