...
import { f as normalizeResolvedSecretInputString, s as coerceSecretRef } from "./types.secrets-B_tDs-aP.js";
...
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-CrNSVTjR.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-DB8tSKUw.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-CeEBYkvj.js";
...
import { s as repairCurrentTokenStorageMetaDeviceId } from "./storage-BKgAgQdG.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-BZ25KAym.js"), import("./logging-CtTBPrGP.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-aKNGUn9l.js").then((credentialsReadModule) => ({
