...
`)},ue=(e,t,n)=>{let r=e.trim();if(!r)return[];let a=r.length?r.split(/\s+/):[],o=a.length?a[a.length-1]:``,[s,c]=o.includes(`:`)?[o.slice(0,o.indexOf(`:`)),o.slice(o.indexOf(`:`)+1)]:[``,``],u=i(s),d=i(c),f=e=>l(e.filter(e=>!!e)),p=f(t.map(e=>e.agentId)).slice(0,6),m=f(t.map(e=>e.channel)).slice(0,6),h=f([...t.map(e=>e.modelProvider),...t.map(e=>e.providerOverride),...n?.byProvider.map(e=>e.provider)??[]]).slice(0,6),g=f([...t.map(e=>e.model),...n?.byModel.map(e=>e.model)??[]]).slice(0,6),_=f(n?.tools.tools.map(e=>e.name)??[]).slice(0,6);if(!u)return[{label:`agent:`,value:`agent:`},{label:`channel:`,value:`channel:`},{label:`provider:`,value:`provider:`},{label:`model:`,value:`model:`},{label:`tool:`,value:`tool:`},{label:`has:errors`,value:`has:errors`},{label:`has:tools`,value:`has:tools`},{label:`minTokens:`,value:`minTokens:`},{label:`maxCost:`,value:`maxCost:`}];let v=[],y=(e,t)=>{for(let n of t)(!d||i(n).includes(d))&&v.push({label:`${e}:${n}`,value:`${e}:${n}`})};switch(u){case`agent`:y(`agent`,p);break;case`channel`:y(`channel`,m);break;case`provider`:y(`provider`,h);break;case`model`:y(`model`,g);break;case`tool`:y(`tool`,_);break;case`has`:[`errors`,`tools`,`context`,`usage`,`model`,`provider`].forEach(e=>{(!d||e.includes(d))&&v.push({label:`has:${e}`,value:`has:${e}`})});break;default:break}return v},de=(e,t)=>{let n=e.trim();if(!n)return`${t} `;let r=n.split(/\s+/);return r[r.length-1]=t,`${r.join(` `)} `},q=e=>i(e),fe=(e,t)=>{let n=e.trim();if(!n)return`${t} `;let r=n.split(/\s+/),i=r[r.length-1]??``,a=t.includes(`:`)?t.split(`:`)[0]:null,o=i.includes(`:`)?i.split(`:`)[0]:null;return i.endsWith(`:`)&&a&&o===a?(r[r.length-1]=t,`${r.join(` `)} `):r.includes(t)?`${r.join(` `)} `:`${r.join(` `)} ${t} `},pe=(e,t)=>{let n=e.trim().split(/\s+/).filter(Boolean).filter(e=>e!==t);return n.length?`${n.join(` `)} `:``},me=(e,t,n)=>{let r=q(t),i=[...g(e).filter(e=>q(e.key??``)!==r).map(e=>e.raw),...n.map(e=>`${t}:${e}`)];return i.length?`${i.join(` `)} `:``};function J(e,t){return t===0?0:e/t*100}var Y=8,he=8,X=null,Z=null,ge=!1,_e=null,ve=!1,ye=null;function be(e,t,n){return Math.min(Math.max(e,t),Math.max(t,n))}function xe(){return Z||(Z=document.createElement(`div`),Z.className=`daily-bar-tooltip daily-bar-tooltip--floating`),Z.isConnected||document.body.append(Z),Z}function Se(e,t){let n=document.createElement(`strong`);n.textContent=t.dateLabel;let r=[n,document.createElement(`br`),document.createTextNode(t.tokensLabel),document.createElement(`br`),document.createTextNode(t.costLabel)];for(let e of t.breakdownLines){let t=document.createElement(`div`);t.textContent=e,r.push(t)}e.replaceChildren(...r)}function Ce(){if(!X)return;if(!X.source.isConnected){ke();return}let e=xe(),t=X.source.getBoundingClientRect();e.style.visibility=`hidden`,e.style.left=`0px`,e.style.top=`0px`;let n=e.getBoundingClientRect(),r=window.innerWidth||document.documentElement.clientWidth,i=window.innerHeight||document.documentElement.clientHeight,a=r-n.width-Y,o=i-n.height-Y,s=be(t.left+t.width/2-n.width/2,Y,a),c=t.top-n.height-he,l=`above`;c<Y&&(l=`below`,c=t.bottom+he),e.dataset.placement=l,e.style.left=`${Math.round(s)}px`,e.style.top=`${Math.round(be(c,Y,o))}px`,e.style.visibility=``}function we(){ge||=(window.addEventListener(`resize`,Ce),window.addEventListener(`scroll`,Ce,!0),!0)}function Te(){ge&&=(window.removeEventListener(`resize`,Ce),window.removeEventListener(`scroll`,Ce,!0),!1)}function Ee(){_e||(_e=new MutationObserver(()=>{X&&!X.source.isConnected&&ke()}),_e.observe(document.body,{childList:!0,subtree:!0}))}function De(){_e?.disconnect(),_e=null}function Oe(e,t,n){(!X||X.source!==e)&&(X={source:e,reasons:new Set,content:t}),X.content=t,X.reasons.add(n),Se(xe(),t),Ce(),we(),Ee()}function ke(e,t){X&&(e&&X.source!==e||t&&(X.reasons.delete(t),X.reasons.size>0)||(X=null,Z?.remove(),Te(),De()))}function Ae(){ve=!0,ye!==null&&window.clearTimeout(ye),ye=window.setTimeout(()=>{ve=!1,ye=null},0)}function je(e,t){ve||Oe(e,t,`focus`)}function Me(e,t,n){e.key!==`Enter`&&e.key!==` `||(e.preventDefault(),n(t,e.shiftKey))}function Ne(e){let t=e.totalCost||0;return{input:{tokens:e.input,cost:e.inputCost||0,pct:J(e.inputCost||0,t)},output:{tokens:e.output,cost:e.outputCost||0,pct:J(e.outputCost||0,t)},cacheRead:{tokens:e.cacheRead,cost:e.cacheReadCost||0,pct:J(e.cacheReadCost||0,t)},cacheWrite:{tokens:e.cacheWrite,cost:e.cacheWriteCost||0,pct:J(e.cacheWriteCost||0,t)},totalCost:t}}function Pe(e,i,a,o,s,c,l,u){if(!(e.length>0||i.length>0||a.length>0))return n;let d=a.length===1?o.find(e=>e.key===a[0]):null,f=d?(d.label||d.key).slice(0,20)+((d.label||d.key).length>20?`…`:``):a.length===1?a[0].slice(0,8)+`…`:r(`usage.filters.sessionsCount`,{count:String(a.length)}),p=d?d.label||d.key:a.length===1?a[0]:a.join(`, `),m=e.length===1?e[0]:r(`usage.filters.daysCount`,{count:String(e.length)}),h=i.length===1?`${i[0]}:00`:r(`usage.filters.hoursCount`,{count:String(i.length)});return t`
  ...
  `}function Fe(e,a,o,s,c,l){if(!e.length)return t`
    ...
    `;let u=o===`tokens`,d=e.map(e=>u?e.totalTokens:e.totalCost),f=Math.max(...d,u?1:1e-4),p=d.filter(e=>e>0),m=f/(p.length>0?Math.min(...p):f),h=d.map(e=>{if(e<=0)return 0;let t=m>50?Math.sqrt(e/f):e/f;return Math.max(6,t*200)}),g=e.length>30?12:e.length>20?18:e.length>14?24:32,_=e.length<=14,v=new Set(a);return t`
    <div class="daily-chart-compact">
      ...
      <div class="daily-chart">
        <div class="daily-chart-bars" style="--bar-max-width: ${g}px">
          ${e.map((a,o)=>{let c=h[o],d=v.has(a.date),f=V(a.date),p=e.length>20?String(Number.parseInt(a.date.slice(8),10)):f,m=e.length>20?`daily-bar-label daily-bar-label--compact`:`daily-bar-label`,g=s===`by-type`?u?[{value:a.output,class:`output`},{value:a.input,class:`input`},{value:a.cacheWrite,class:`cache-write`},{value:a.cacheRead,class:`cache-read`}]:[{value:a.outputCost??0,class:`output`},{value:a.inputCost??0,class:`input`},{value:a.cacheWriteCost??0,class:`cache-write`},{value:a.cacheReadCost??0,class:`cache-read`}]:[],y=s===`by-type`?u?[`${r(`usage.breakdown.output`)} ${O(a.output)}`,`${r(`usage.breakdown.input`)} ${O(a.input)}`,`${r(`usage.breakdown.cacheWrite`)} ${O(a.cacheWrite)}`,`${r(`usage.breakdown.cacheRead`)} ${O(a.cacheRead)}`]:[`${r(`usage.breakdown.output`)} ${z(a.outputCost??0)}`,`${r(`usage.breakdown.input`)} ${z(a.inputCost??0)}`,`${r(`usage.breakdown.cacheWrite`)} ${z(a.cacheWriteCost??0)}`,`${r(`usage.breakdown.cacheRead`)} ${z(a.cacheReadCost??0)}`]:[],b=u?O(a.totalTokens):z(a.totalCost),x={dateLabel:H(a.date),tokensLabel:`${O(a.totalTokens)} ${i(r(`usage.metrics.tokens`))}`.trim(),costLabel:z(a.totalCost),breakdownLines:y};return t`
              <div
                ...
                @pointerdown=${Ae}
                @mouseenter=${e=>Oe(e.currentTarget,x,`hover`)}
                @mouseleave=${e=>ke(e.currentTarget,`hover`)}
                @focus=${e=>je(e.currentTarget,x)}
                @blur=${e=>ke(e.currentTarget,`focus`)}
                @keydown=${e=>Me(e,a.date,l)}
                @click=${e=>l(a.date,e.shiftKey)}
              >
                ${s===`by-type`?t`
                      <div
                      ...
                      >
                        ${(()=>{let e=g.reduce((e,t)=>e+t.value,0)||1;return g.map(n=>t`
                              <div
                    ...
                    `:t` <div class="daily-bar" style="height: ${c.toFixed(0)}px"></div> `}
  ...
  `}function Ie(e,n){let i=Ne(e),a=n===`tokens`,o=e.totalTokens||1,s={output:J(e.output,o),input:J(e.input,o),cacheWrite:J(e.cacheWrite,o),cacheRead:J(e.cacheRead,o)};return t`
  ...
  `}function Re(e,r,i,a){let o=[`usage-insight-card`,a?.className].filter(Boolean).join(` `),s=[`usage-error-list`,a?.listClassName].filter(Boolean).join(` `);return t`
    <div class=${o}>
      <div class="usage-insight-title">${e}</div>
      ${r.length===0?t`<div class="muted">${i}</div>`:t`
            <div class=${s}>
  ...
  `}function Q(e){let n=[`stat`,`usage-summary-card`,e.className,e.tone?`usage-summary-card--${e.tone}`:``].filter(Boolean).join(` `),r=[`stat-value`,`usage-summary-value`,e.tone??``,e.compactValue?`usage-summary-value--compact`:``].filter(Boolean).join(` `);return t`
    <div class=${n}>
    ...
    <section class="card usage-overview-card">
      ...
      <div class="usage-overview-layout">
        <div class="usage-summary-grid">
          ${Q({title:r(`usage.overview.messages`),hint:r(`usage.overview.messagesHint`),value:a.messages.total,sub:`${a.messages.user} ${i(r(`usage.overview.user`))} · ${a.messages.assistant} ${i(r(`usage.overview.assistant`))}`,className:`usage-summary-card--hero`})}
          ${Q({title:r(`usage.overview.throughput`),hint:S,value:v,sub:y,className:`usage-summary-card--hero usage-summary-card--throughput`,compactValue:!0})}
          ${Q({title:r(`usage.overview.toolCalls`),hint:r(`usage.overview.toolCallsHint`),value:a.tools.totalCalls,sub:`${a.tools.uniqueTools} ${r(`usage.overview.toolsUsed`)}`,className:`usage-summary-card--half`})}
          ${Q({title:r(`usage.overview.avgTokens`),hint:C,value:O(f),sub:r(`usage.overview.acrossMessages`,{count:String(a.messages.total||0)}),className:`usage-summary-card--half`})}
          ${Q({title:r(`usage.overview.cacheHitRate`),hint:x,value:g,sub:`${O(e.cacheRead)} ${r(`usage.overview.cached`)} · ${O(m)} ${r(`usage.overview.prompt`)}`,tone:h>.6?`good`:h>.3?`warn`:`bad`,className:`usage-summary-card--medium`})}
          ${Q({title:r(`usage.overview.errorRate`),hint:ee,value:`${_.toFixed(2)}%`,sub:`${a.messages.errors} ${i(r(`usage.overview.errors`))} · ${b} ${r(`usage.overview.avgSession`)}`,tone:_>5?`bad`:_>1?`warn`:`good`,className:`usage-summary-card--medium`})}
          ${Q({title:r(`usage.overview.avgCost`),hint:w,value:z(p,4),sub:`${z(e.totalCost)} ${i(r(`usage.breakdown.total`))}`,className:`usage-summary-card--compact`})}
          ${Q({title:r(`usage.overview.sessions`),hint:r(`usage.overview.sessionsHint`),value:l,sub:r(`usage.overview.sessionsInRange`,{count:String(d)}),className:`usage-summary-card--compact`})}
          ${Q({title:r(`usage.overview.errors`),hint:r(`usage.overview.errorsHint`),value:a.messages.errors,sub:`${a.messages.toolResults} ${r(`usage.overview.toolResults`)}`,className:`usage-summary-card--compact`})}
        </div>
        <div class="usage-insights-grid">
          ${Le(r(`usage.overview.topModels`),E,r(`usage.overview.noModelData`))}
          ${Le(r(`usage.overview.topProviders`),D,r(`usage.overview.noProviderData`))}
          ${Le(r(`usage.overview.topTools`),k,r(`usage.overview.noToolCalls`))}
          ${Le(r(`usage.overview.topAgents`),A,r(`usage.overview.noAgentData`))}
          ${Le(r(`usage.overview.topChannels`),te,r(`usage.overview.noChannelData`))}
          ${Re(r(`usage.overview.peakErrorDays`),T,r(`usage.overview.noErrorData`))}
          ${Re(r(`usage.overview.peakErrorHours`),c,r(`usage.overview.noErrorData`),{className:`usage-insight-card--wide`,listClassName:`usage-error-list--hours`})}
        </div>
      </div>
    </section>
  `}function Be(e,a,o,s,c,l,d,f,p,m,h,g,_,v,y){let b=e=>_.includes(e),x=e=>{let t=e.label||e.key;return t.startsWith(`agent:`)&&t.includes(`?token=`)?t.slice(0,t.indexOf(`?token=`)):t},ee=async e=>{let t=x(e);try{await navigator.clipboard.writeText(t)}catch{}},S=e=>{let t=[];return b(`channel`)&&e.channel&&t.push(`channel:${e.channel}`),b(`agent`)&&e.agentId&&t.push(`agent:${e.agentId}`),b(`provider`)&&(e.modelProvider||e.providerOverride)&&t.push(`provider:${e.modelProvider??e.providerOverride}`),b(`model`)&&e.model&&t.push(`model:${e.model}`),b(`messages`)&&e.usage?.messageCounts&&t.push(`msgs:${e.usage.messageCounts.total}`),b(`tools`)&&e.usage?.toolUsage&&t.push(`tools:${e.usage.toolUsage.totalCalls}`),b(`errors`)&&e.usage?.messageCounts&&t.push(`errors:${e.usage.messageCounts.errors}`),b(`duration`)&&e.usage?.durationMs&&t.push(`dur:${u(e.usage.durationMs,{spaced:!0})??`—`}`),t},C=new Set(o),w=(e,t)=>{let n=e.usage;return n?C.size>0&&n.dailyBreakdown&&n.dailyBreakdown.length>0?n.dailyBreakdown.reduce((e,n)=>C.has(n.date)?e+(t===`tokens`?n.tokens:n.cost):e,0):t===`tokens`?n.totalTokens??0:n.totalCost??0:0},T=e=>w(e,s?`tokens`:`cost`),E=e=>{switch(c){case`recent`:return e.updatedAt??0;case`messages`:return e.usage?.messageCounts?.total??0;case`errors`:return e.usage?.messageCounts?.errors??0;case`cost`:return w(e,`cost`);case`tokens`:return w(e,`tokens`)}return c},D=[...e].toSorted((e,t)=>{let n=E(t)-E(e);if(n!==0)return n;let r=(t.updatedAt??0)-(e.updatedAt??0);return r===0?x(e).localeCompare(x(t)):r}),k=l===`asc`?D.toReversed():D,A=k.reduce((e,t)=>e+T(t),0),te=k.length?A/k.length:0,j=k.reduce((e,t)=>e+(t.usage?.messageCounts?.errors??0),0),M=(e,i)=>{let a=T(e),o=x(e),c=S(e);return t`
      <div
  ...
  `}var Ve=.75,He=.06,Ue=5,$=12,We=.7;function Ge(e,t){return!t||t<=0?0:e/t*100}function Ke(e){return e<0xe8d4a51000?e*1e3:e}function qe(e,t,n){let r=Math.min(t,n),i=Math.max(t,n);return e.filter(e=>{if(e.timestamp<=0)return!0;let t=Ke(e.timestamp);return t>=r&&t<=i})}function Je(e,o,s){let c=o||e.usage;if(!c)return t` <div class="usage-empty-block">${r(`usage.details.noUsageData`)}</div> `;let l=e=>e?a(e):r(`usage.common.emptyValue`),d=[];e.channel&&d.push(`channel:${e.channel}`),e.agentId&&d.push(`agent:${e.agentId}`),(e.modelProvider||e.providerOverride)&&d.push(`provider:${e.modelProvider??e.providerOverride}`),e.model&&d.push(`model:${e.model}`);let f=c.toolUsage?.tools.slice(0,6)??[],p,m,h;if(s){let e=new Map;for(let t of s){let{tools:n}=S(t.content);for(let[t]of n)e.set(t,(e.get(t)||0)+1)}h=f.map(t=>({label:t.name,value:`${e.get(t.name)??0}`,sub:r(`usage.overview.calls`)})),p=[...e.values()].reduce((e,t)=>e+t,0),m=e.size}else h=f.map(e=>({label:e.name,value:`${e.count}`,sub:r(`usage.overview.calls`)})),p=c.toolUsage?.totalCalls??0,m=c.toolUsage?.uniqueTools??0;let g=c.modelUsage?.slice(0,6).map(e=>({label:e.model??r(`usage.common.unknown`),value:z(e.totals.totalCost),sub:O(e.totals.totalTokens)}))??[];return t`
    ...
    <div class="usage-insights-grid usage-insights-grid--tight">
      ${Le(r(`usage.overview.topTools`),h,r(`usage.overview.noToolCalls`))}
      ${Le(r(`usage.details.modelMix`),g,r(`usage.overview.noModelData`))}
    </div>
      ...
      <div class="timeseries-chart-wrapper">
        <svg viewBox="0 0 ${400} ${118}" class="timeseries-svg">
          ...
          ${e`
            ...
            <rect x="${W-Ue/2}" y="${F.top+L/2-$/2}" width="${Ue}" height="${$}" rx="1.5" fill="var(--accent)" class="cursor-handle" />
            <line x1="${W-We}" y1="${F.top+L/2-$/5}" x2="${W-We}" y2="${F.top+L/2+$/5}" stroke="var(--bg)" stroke-width="0.4" pointer-events="none" />
            <line x1="${W+We}" y1="${F.top+L/2-$/5}" x2="${W+We}" y2="${F.top+L/2+$/5}" stroke="var(--bg)" stroke-width="0.4" pointer-events="none" />
          `}
          <!-- Right cursor line + handle -->
          ${e`
            <line x1="${G}" y1="${F.top}" x2="${G}" y2="${F.top+L}" stroke="var(--accent)" stroke-width="0.8" opacity="0.7" />
            <rect x="${G-Ue/2}" y="${F.top+L/2-$/2}" width="${Ue}" height="${$}" rx="1.5" fill="var(--accent)" class="cursor-handle" />
            <line x1="${G-We}" y1="${F.top+L/2-$/5}" x2="${G-We}" y2="${F.top+L/2+$/5}" stroke="var(--bg)" stroke-width="0.4" pointer-events="none" />
            <line x1="${G+We}" y1="${F.top+L/2-$/5}" x2="${G+We}" y2="${F.top+L/2+$/5}" stroke="var(--bg)" stroke-width="0.4" pointer-events="none" />
          `}
        </svg>
      ...
      ${R?t`
            <div class="timeseries-breakdown">
              ...
              <div class="cost-breakdown-bar cost-breakdown-bar--compact">
                <div
                  class="cost-segment output"
                  style="width: ${Ge(j,re).toFixed(1)}%"
                ></div>
                <div
                  class="cost-segment input"
                  style="width: ${Ge(M,re).toFixed(1)}%"
                ></div>
                <div
                  class="cost-segment cache-write"
                  style="width: ${Ge(P,re).toFixed(1)}%"
                ></div>
                <div
                  class="cost-segment cache-read"
                  style="width: ${Ge(N,re).toFixed(1)}%"
                ></div>
              </div>
              <div class="cost-breakdown-legend">
  ...
  `}function it(e){let t=e.currentTarget;if(!t.open)return;let n=e=>{e.composedPath().includes(t)||(t.open=!1,window.removeEventListener(`click`,n,!0))};window.addEventListener(`click`,n,!0)}function at(e){let{data:i,filters:a,display:o,detail:s,callbacks:c}=e,l=c.filters,u=c.display,f=c.details;if(i.loading&&!i.totals)return t`<div class="usage-page">${nt(a)}</div>`;let p=o.chartMode===`tokens`,m=a.query.trim().length>0,h=a.queryDraft.trim().length>0,_=new Set(a.selectedDays),v=new Set(a.selectedSessions),y=[...i.sessions].toSorted((e,t)=>{let n=p?e.usage?.totalTokens??0:e.usage?.totalCost??0;return(p?t.usage?.totalTokens??0:t.usage?.totalCost??0)-n}),b=a.agentId?y.filter(e=>q(e.agentId??``)===q(a.agentId??``)):y,x=_.size>0?b.filter(e=>{if(e.usage?.activityDates?.length)return e.usage.activityDates.some(e=>_.has(e));if(!e.updatedAt)return!1;let t=new Date(e.updatedAt),n=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)}`;return _.has(n)}):b,S=ee(a.selectedHours.length>0?x.filter(e=>ne(e,a.selectedHours,a.timeZone)):x,a.query),C=S.sessions,w=S.warnings,T=ue(a.queryDraft,b,i.aggregates),E=g(a.query),D=e=>{let t=q(e);return E.filter(e=>q(e.key??``)===t).map(e=>e.value).filter(Boolean)},k=e=>{let t=new Set;for(let n of e)n&&t.add(n);return Array.from(t)},A=k([...i.agents,...y.map(e=>e.agentId)]).slice(0,12),j=k(b.map(e=>e.channel)).slice(0,12),M=k([...b.map(e=>e.modelProvider),...b.map(e=>e.providerOverride),...i.aggregates?.byProvider.map(e=>e.provider)??[]]).slice(0,12),N=k([...b.map(e=>e.model),...i.aggregates?.byModel.map(e=>e.model)??[]]).slice(0,12),P=k(i.aggregates?.tools.tools.map(e=>e.name)??[]).slice(0,12),F=a.selectedSessions.length===1?i.sessions.find(e=>e.key===a.selectedSessions[0])??C.find(e=>e.key===a.selectedSessions[0]):null,I=e=>e.reduce((e,t)=>t.usage?tt(e,t.usage):e,et()),L=e=>i.costDaily.filter(t=>e.has(t.date)).reduce((e,t)=>tt(e,t),et()),R,B,V=b.length;if(a.selectedSessions.length>0){let e=C.filter(e=>v.has(e.key));R=I(e),B=e.length}else a.selectedDays.length>0&&a.selectedHours.length===0?(R=L(_),B=C.length):a.selectedHours.length>0||m?(R=I(C),B=C.length):a.agentId?(R=I(b),B=V):(R=i.totals,B=V);let H=a.selectedSessions.length>0?C.filter(e=>v.has(e.key)):m||a.selectedHours.length>0?C:a.selectedDays.length>0?x:y,U=a.selectedSessions.length>0||m||a.selectedHours.length>0||a.selectedDays.length>0||!!a.agentId,W=G(U?H:[],i.aggregates),se=i.sessionsLimitReached&&!U,K=se?I(H):R,J=se?G(H):W,Y=a.selectedSessions.length>0?(()=>{let e=C.filter(e=>v.has(e.key)),t=new Set;for(let n of e)for(let e of n.usage?.activityDates??[])t.add(e);return t.size>0?i.costDaily.filter(e=>t.has(e.date)):i.costDaily})():i.costDaily,he=ae(H,K,J),X=!i.loading&&!i.totals&&i.sessions.length===0,Z=d(i.cacheStatus),ge=(K?.missingCostEntries??0)>0||(K?K.totalTokens>0&&K.totalCost===0&&K.input+K.output+K.cacheRead+K.cacheWrite>0:!1),_e=[{label:r(`usage.presets.today`),days:1},{label:r(`usage.presets.last7d`),days:7},{label:r(`usage.presets.last30d`),days:30},{label:r(`usage.presets.last90d`),days:90},{label:r(`usage.presets.last1y`),days:365}],ve=e=>{let t=new Date,n=new Date;n.setDate(n.getDate()-(e-1)),l.onStartDateChange(ie(n)),l.onEndDateChange(ie(t))},ye=()=>{l.onStartDateChange(`1970-01-01`),l.onEndDateChange(ie(new Date))},be=(e,i,o)=>{if(o.length===0)return n;let s=D(e),c=new Set(s.map(e=>q(e))),u=o.length>0&&o.every(e=>c.has(q(e))),d=s.length;return t`
      <details class="usage-filter-select" @toggle=${it}>
        ...
        <div class="usage-filter-popover">
          <div class="usage-filter-actions">
            <button
              class="btn btn--sm"
              @click=${t=>{t.preventDefault(),t.stopPropagation(),l.onQueryDraftChange(me(a.queryDraft,e,o))}}
              ?disabled=${u}
            >
            ...
            <button
              class="btn btn--sm"
              @click=${t=>{t.preventDefault(),t.stopPropagation(),l.onQueryDraftChange(me(a.queryDraft,e,[]))}}
              ?disabled=${d===0}
            >
            ...
            ${o.map(n=>t`
                <label class="usage-filter-option">
                  <input
                    type="checkbox"
                    .checked=${c.has(q(n))}
                    @change=${t=>{let r=t.target,i=`${e}:${n}`;l.onQueryDraftChange(r.checked?fe(a.queryDraft,i):pe(a.queryDraft,i))}}
                  />
                  <span>${n}</span>
                </label>
              `)}
    ...
    <div class="usage-page">
      <section class="card usage-header ${o.headerPinned?`pinned`:``}">
        <div class="usage-header-row">
          <div class="usage-header-title">
            ...
            ${i.loading||Z?t`<span class="usage-refresh-indicator" title=${Z??``}>
                  ${r(`usage.loading.badge`)}
                </span>`:n}
            ${X?t`<span class="usage-query-hint">${r(`usage.empty.hint`)}</span>`:n}
          </div>
          <div class="usage-header-metrics">
            ${R?t`
                  <span class="usage-metric-badge">
                    <strong>${O(R.totalTokens)}</strong>
                    ${r(`usage.metrics.tokens`)}
                  </span>
                  <span class="usage-metric-badge">
                    <strong>${z(R.totalCost)}</strong>
                    ${r(`usage.metrics.cost`)}
                  </span>
                  <span class="usage-metric-badge">
                    <strong>${B}</strong>
                    ${r(B===1?`usage.metrics.session`:`usage.metrics.sessions`)}
                  </span>
                `:n}
            <button
              ...
              <div class="usage-export-popover">
                <div class="usage-export-list">
                  <button
                    ...
                    @click=${()=>oe(`openclaw-usage-sessions-${Se}.csv`,ce(C),`text/csv`)}
                    ?disabled=${C.length===0}
                  >
                  ...
                  <button
                    class="usage-export-item"
                    @click=${()=>oe(`openclaw-usage-daily-${Se}.csv`,le(Y),`text/csv`)}
                    ?disabled=${Y.length===0}
                  >
                  ...
                  <button
                    class="usage-export-item"
                    @click=${()=>oe(`openclaw-usage-${Se}.json`,JSON.stringify({totals:R,sessions:C,daily:Y,aggregates:W},null,2),`application/json`)}
                    ?disabled=${C.length===0&&Y.length===0}
                  >
                    ${r(`usage.export.json`)}
                  </button>
                </div>
        ...
        <div class="usage-header-row">
          <div class="usage-controls">
            ${Pe(a.selectedDays,a.selectedHours,a.selectedSessions,i.sessions,l.onClearDays,l.onClearHours,l.onClearSessions,l.onClearFilters)}
          ...
          <div class="usage-query-bar">
            ...
            <div class="usage-query-actions">
              ...
              <span class="usage-query-hint">
                ${m?r(`usage.query.matching`,{shown:String(C.length),total:String(V)}):r(`usage.query.inRange`,{total:String(V)})}
              </span>
            </div>
          </div>
          <div class="usage-filter-row">
            ${xe()}
            ${be(`channel`,r(`usage.filters.channel`),j)}
            ${be(`provider`,r(`usage.filters.provider`),M)}
            ${be(`model`,r(`usage.filters.model`),N)}
            ${be(`tool`,r(`usage.filters.tool`),P)}
            <span class="usage-query-hint">${r(`usage.query.tip`)}</span>
          </div>
          ${E.length>0?t`
                <div class="usage-query-chips">
                  ${E.map(e=>{let n=e.raw;return t`
                      <span class="usage-query-chip">
                        ${n}
                        <button
                          title=${r(`usage.filters.remove`)}
                          @click=${()=>l.onQueryDraftChange(pe(a.queryDraft,n))}
                        >
                          ×
                        </button>
                      </span>
                ...
                <div class="usage-query-suggestions">
                  ${T.map(e=>t`
                      <button
                        ...
                        @click=${()=>l.onQueryDraftChange(de(a.queryDraft,e.value))}
                      >
                        ${e.label}
                      </button>
                    `)}
      ...
      ${X?rt(l.onRefresh):t`
            ${ze(K,J,he,ge,te(H,a.timeZone),B,V)}
            ${re(H,a.timeZone,a.selectedHours,l.onSelectHour)}

            <div class="usage-grid">
              <div class="usage-grid-column">
                <div class="card usage-left-card">
                  ${Fe(Y,a.selectedDays,o.chartMode,o.dailyChartMode,u.onDailyChartModeChange,l.onSelectDay)}
                  ${R?Ie(R,o.chartMode):n}
                </div>
                ${Be(C,a.selectedSessions,a.selectedDays,p,o.sessionSort,o.sessionSortDir,o.recentSessions,o.sessionsTab,f.onSelectSession,u.onSessionSortChange,u.onSessionSortDirChange,u.onSessionsTabChange,o.visibleColumns,V,l.onClearSessions)}
              </div>
              ${F?t`<div class="usage-grid-column">
                    ${Xe(F,s.timeSeries,s.timeSeriesLoading,s.timeSeriesMode,f.onTimeSeriesModeChange,s.timeSeriesBreakdownMode,f.onTimeSeriesBreakdownChange,s.timeSeriesCursorStart,s.timeSeriesCursorEnd,f.onTimeSeriesCursorRangeChange,a.startDate,a.endDate,a.selectedDays,s.sessionLogs,s.sessionLogsLoading,s.sessionLogsExpanded,f.onToggleSessionLogsExpanded,s.logFilters,f.onLogFilterRolesChange,f.onLogFilterToolsChange,f.onLogFilterHasToolsChange,f.onLogFilterQueryChange,f.onLogFilterClear,o.contextExpanded,f.onToggleContextExpanded,l.onClearSessions)}
                  </div>`:n}
            </div>
          `}
    </div>
  `}export{at as renderUsage};
//# sourceMappingURL=usage-Dj0GdK_L.js.map