      ...
      <div style="margin-top: 16px; border-top: 1px solid var(--border); padding-top: 16px;">
        ...
        ${n.clawhubInstallMessage?t`<div
            ...
            >
              ...
              ${n.clawhubInstallMessage.acknowledgeSlug?t`<button
                    type="button"
                    class="btn btn--sm"
                    style="margin-top: 10px; white-space: normal;"
                    ?disabled=${n.clawhubInstallSlug===n.clawhubInstallMessage.acknowledgeSlug}
                    @click=${()=>n.onClawHubInstall(n.clawhubInstallMessage?.acknowledgeSlug??``,!0,n.clawhubInstallMessage?.acknowledgeVersion)}
                  >
                    ${n.clawhubInstallMessage.acknowledgeLabel??`Acknowledge risk and install`}
                  </button>`:r}
            </div>`:r}
        ${E(n)}
      </div>
...
//# sourceMappingURL=skills-zyyyNGUt.js.map