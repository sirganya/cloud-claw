...
import { f as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-qH92jzOW.js";
import { t as formatHelpExamples } from "./help-format-CAcwboTs.js";
import { t as runSecurityAudit } from "./audit-P10V6BYg.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-BJbx-ZNA.js");
