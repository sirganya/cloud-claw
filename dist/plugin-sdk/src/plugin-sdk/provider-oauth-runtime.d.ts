 ...
 */
export declare function oauthSuccessHtml(
 ...
 */
export declare function oauthErrorHtml(
 ...
 */
export declare function parseOAuthAuthorizationInput(
...
export declare function resolveOAuthTokenLifetimeMs(
...
export declare function resolveOAuthTokenExpiresAt(
/** Provider `expires_in` value in seconds. */
 ...
 */
export declare function createOAuthLoginCancelledError(): Error;
/** Throws the shared OAuth cancellation error when a login signal is already aborted. */
export declare function throwIfOAuthLoginAborted(
...
export declare function withOAuthLoginAbort<T>(
...
export declare function buildOAuthRequestSignal(options: {
