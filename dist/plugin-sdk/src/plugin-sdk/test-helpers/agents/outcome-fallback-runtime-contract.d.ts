...
export declare const OUTCOME_FALLBACK_RUNTIME_CONTRACT: {
    readonly primaryProvider: "openai";
...
export declare function createContractRunResult(overrides?: Partial<EmbeddedAgentRunResult>): EmbeddedAgentRunResult;
export declare function createContractFallbackConfig(): {
    readonly agents: {
        readonly defaults: {
            readonly model: {
                readonly primary: "openai/gpt-5.4";
