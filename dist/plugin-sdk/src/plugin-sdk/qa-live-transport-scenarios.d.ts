...
export type LiveTransportStandardScenarioId = "canary" | "mention-gating" | "allowlist-block" | "top-level-reply-shape" | "quote-reply" | "restart-resume" | "thread-follow-up" | "thread-isolation" | "reaction-observation" | "help-command";
