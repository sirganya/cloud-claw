...
import { type AllowAlwaysPattern, resolveAllowAlwaysPatternEntries } from "./exec-approvals-allowlist.js";
...
export declare function resolveExecApprovalsDisplayPath(): string;
export declare function resolveExecApprovalsTranscriptPath(): string;
...
export declare function hasExactCommandDurableExecApproval(params: {
    allowlist?: readonly ExecAllowlistEntry[];
    commandText?: string | null;
}): boolean;
...
export type AllowAlwaysPersistenceReason = "no-reusable-pattern" | "prompt-only" | "runtime-payload" | "unplanned";
...
export declare function resolveAllowAlwaysPersistenceDecision(params: {
    segments: ExecCommandSegment[];
    commandText?: string | null;
    cwd?: string;
    env?: NodeJS.ProcessEnv;
...
export declare function persistAllowAlwaysDecision(params: {
    approvals: ExecApprovalsFile;
    agentId: string | undefined;
...
export declare const OPTIONAL_EXEC_APPROVAL_DECISIONS: readonly ["allow-always"];
export type ExecApprovalUnavailableDecision = (typeof OPTIONAL_EXEC_APPROVAL_DECISIONS)[number];
export declare function normalizeExecApprovalUnavailableDecisions(decisions?: readonly string[] | readonly ExecApprovalUnavailableDecision[] | null): readonly ExecApprovalUnavailableDecision[];
...
export declare function resolveExecApprovalUnavailableDecisions(params?: {
    ask?: string | null;
    allowAlwaysPersistence?: AllowAlwaysPersistenceDecision | null;
