...
export declare function getWindowsCmdExePath(env?: Record<string, string | undefined>): string;
export declare function getWindowsSystem32ExePath(executableName: string, env?: Record<string, string | undefined>): string;
export declare function getWindowsPowerShellExePath(env?: Record<string, string | undefined>): string;
export declare function getWindowsWmicExePath(env?: Record<string, string | undefined>): string;
