...
export declare function collectHooksHardeningFindings(cfg: OpenClawConfig, env?: NodeJS.ProcessEnv, options?: HooksHardeningAuditOptions): SecurityAuditFinding[];
export declare function collectGatewayHttpSessionKeyOverrideFindings(cfg: OpenClawConfig): SecurityAuditFinding[];
export declare function collectGatewayHttpNoAuthFindings(cfg: OpenClawConfig, env: NodeJS.ProcessEnv, options?: GatewayHttpNoAuthAuditOptions): SecurityAuditFinding[];
