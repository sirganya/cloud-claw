...
export declare function collectGatewayConfigFindings(cfg: OpenClawConfig, sourceConfig: OpenClawConfig, env: NodeJS.ProcessEnv, options?: {
    gatewayAuthOverride?: SecurityAuditGatewayAuthOverride;
