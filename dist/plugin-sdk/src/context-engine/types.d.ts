...
export type ContextEngineRuntimeReasonCode = "provider_timeout" | "provider_unavailable" | "rate_limited" | "context_overflow" | "runtime_unavailable" | "unknown";
...
export declare class ContextEngineRuntimeSettingsUnavailableError extends Error {
    readonly code = "context_engine_runtime_settings_unavailable";
    constructor(message?: string);
}
export declare class ContextEngineRuntimeSettingsUnsupportedError extends Error {
