...
export declare function stripAssistantInternalTraceLines(text: string): string;
export type AssistantVisibleTextSanitizerProfile = "delivery" | "history" | "internal-scaffolding" | "tool-progress";
