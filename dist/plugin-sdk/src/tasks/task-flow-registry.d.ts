...
export declare function createFlowRecord(params: CreateFlowRecordParams): TaskFlowRecord | null;
...
export declare function syncFlowFromTaskResult(task: Pick<TaskRecord, "parentFlowId" | "status" | "terminalOutcome" | "notifyPolicy" | "label" | "task" | "lastEventAt" | "endedAt" | "taskId" | "terminalSummary" | "progressSummary">): TaskFlowSyncResult;
export declare function syncFlowFromTask(task: Parameters<typeof syncFlowFromTaskResult>[0]): TaskFlowRecord | null;
