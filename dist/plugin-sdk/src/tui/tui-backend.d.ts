...
export type TuiSessionList = {
    ...
    sessions: Array<Pick<SessionInfo, "thinkingLevel" | "thinkingLevels" | "fastMode" | "verboseLevel" | "reasoningLevel" | "model" | "contextTokens" | "inputTokens" | "outputTokens" | "totalTokens" | "totalTokensFresh" | "goal" | "modelProvider" | "displayName"> & {
        key: string;
        sessionId?: string;
