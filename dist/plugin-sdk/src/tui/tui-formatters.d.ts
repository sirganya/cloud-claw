...
export declare function formatRemoteConnectionHostFooter(connectionUrl: string): string | null;
export declare function formatGoalFooter(goal?: SessionGoal): string | null;
