import { type ApplyPatchPathExtractionOptions } from "../agents/apply-patch-paths.js";
/**
 ...
 */
export declare function deriveToolParams(toolName: string, params: unknown, options?: HostToolDerivationOptions): HostToolDerivedParams;
