...
export declare function createHookRunnerWithRegistry(hooks: Array<{
    ...
    runner: {
        ...
        runAgentEnd: (event: import("./hook-types.ts").PluginHookAgentEndEvent, ctx: PluginHookAgentContext, optionsLocal?: import("./hooks.js").VoidHookRunOptions) => Promise<void>;
        ...
        runReplyPayloadSending: (event: import("./hook-types.ts").PluginHookReplyPayloadSendingEvent, ctx: import("./hook-types.ts").PluginHookReplyPayloadSendingContext) => Promise<import("./hook-types.ts").PluginHookReplyPayloadSendingResult | undefined>;
        ...
        runBeforeToolCall: (event: import("./hook-types.ts").PluginHookBeforeToolCallEvent, ctx: import("./hook-types.ts").PluginHookToolContext) => Promise<import("./hook-before-tool-call-result.ts").PluginHookBeforeToolCallResult | undefined>;
        ...
        runResolveExecEnv: (event: import("./hook-types.ts").PluginHookResolveExecEnvEvent, ctx: import("./hook-types.ts").PluginHookResolveExecEnvContext) => Promise<Record<string, string>>;
