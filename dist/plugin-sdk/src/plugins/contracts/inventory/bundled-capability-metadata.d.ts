...
export type BundledCapabilityManifest = Pick<PluginManifest, "id" | "autoEnableWhenConfiguredProviders" | "cliBackends" | "contracts" | "legacyPluginIds" | "providers" | "setup">;
...
type BundledContractIdSnapshotKey = Exclude<keyof Omit<BundledPluginContractSnapshot, "pluginId">, "providerEnvVars">;
