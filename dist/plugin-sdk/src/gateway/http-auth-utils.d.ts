...
export declare function authorizeOpenAiCompatibleHttpModelOverride(req: IncomingMessage, requestAuth: AuthorizedGatewayHttpRequest): {
    allowed: true;
} | {
    allowed: false;
    missingScope: typeof ADMIN_SCOPE;
};
export {};
