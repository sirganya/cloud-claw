...
export declare const EMBEDDED_AGENT_RESOURCE_LOADER_DISCOVERY_OPTIONS: {
    noExtensions: true;
    noSkills: true;
...
export declare function createEmbeddedAgentResourceLoader(options: Pick<DefaultResourceLoaderInit, "cwd" | "agentDir" | "settingsManager" | "extensionFactories">): DefaultResourceLoader;
export {};
