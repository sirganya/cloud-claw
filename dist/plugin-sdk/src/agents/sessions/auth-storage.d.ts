 ...
 */
import type { OAuthCredentials, OAuthLoginCallbacks, OAuthProviderId } from "../../llm/utils/oauth/types.js";
...
export declare class AuthStorage {
     ...
     */
    getOAuthProviders(): import("../../plugin-sdk/provider-oauth-runtime.ts").OAuthProviderInterface[];
}
export {};
