 ...
 */
export declare function findExactModelReferenceMatch(modelReference: string, availableModels: Model[]): Model | undefined;
 ...
 */
export declare function parseModelPattern(pattern: string, availableModels: Model[], options?: {
 ...
 */
export declare function restoreModelFromSession(savedProvider: string, savedModelId: string, currentModel: Model | undefined, shouldPrintMessages: boolean, modelRegistry: ModelRegistry): Promise<{
    model: Model | undefined;
    fallbackMessage: string | undefined;
}>;
