...
import type { Api, AssistantMessageEvent, AssistantMessageEventStreamContract, Context, ImageContent, Model, SimpleStreamOptions, TextContent, ToolResultMessage } from "openclaw/plugin-sdk/llm";
import type { Static, TSchema } from "typebox";
import type { Theme } from "../../modes/interactive/theme/theme.js";
import type { AgentMessage, AgentToolResult, AgentToolUpdateCallback, ThinkingLevel, ToolExecutionMode } from "../../runtime/index.js";
...
import type { BashToolDetails, BashToolInput, EditToolDetails, EditToolInput, FindToolDetails, FindToolInput, GrepToolDetails, GrepToolInput, LsToolDetails, LsToolInput, ReadToolDetails, ReadToolInput, WriteToolInput } from "../tools/tool-contracts.js";
 ...
 * `unknown`.
 */
export declare function defineTool<TParams extends TSchema, TDetails = unknown, TState = unknown>(tool: ToolDefinition<TParams, TDetails, TState>): ToolDefinition<TParams, TDetails, TState> & AnyToolDefinition;
