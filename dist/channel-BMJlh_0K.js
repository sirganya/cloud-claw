...
import { i as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-IR0aNLdV.js";
...
import { E as projectConfigAccountIdWarningCollector, g as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-CSebREiU.js";
...
import { i as loadSessionStore } from "./session-store-runtime-hI4O7_tV.js";
import { t as createSetupTranslator } from "./i18n-C0k1rM_n.js";
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-DBCnrZXR.js";
...
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, n as inspectFeishuCredentials, p as isRecord$1, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-DYW6tCDc.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-B9vkkHUB.js";
import { n as createFeishuSendReceipt } from "./send-result-D-3eKiJK.js";
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-BrnYeord.js";
import { i as listFeishuDirectoryPeers, r as listFeishuDirectoryGroups, t as buildFeishuPresentationCard } from "./presentation-card-Cp85QZjP.js";
import { t as messageActionTargetAliases } from "./security-audit-iWJ2X2EZ.js";
import { s as resolveFeishuGroupToolPolicy } from "./policy-t5VgKR90.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-SJvDp7M-.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-Cx2PPLbX.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-tR_sjqBX.js";
...
const loadAppRegistrationModule = async () => {
	appRegistrationModulePromise ??= import("./app-registration-642SpwXu.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, accountId, configured }) => {
			...
			if (configured && account.configured) try {
				const { probeFeishu } = await import("./probe-1mOpNyOa.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-Cpa4haY7.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-DSWtO9xk.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-C2qjM_Hn.js");
