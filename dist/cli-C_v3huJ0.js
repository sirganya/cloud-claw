...
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-OESLmfz7.js";
import { n as matrixSetupAdapter } from "./setup-core-IxM0FmFU.js";
import { t as withResolvedActionClient } from "./client-B4SKAB6F.js";
import { r as resolveMatrixAuthContext } from "./config-DnrmPkIM.js";
...
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-CWYbFSkI.js";
...
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-DqCJBIos.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-BNewTdzG.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-6pMs6-zQ.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-V2xPMoQb.js");
