...
import { u as normalizeAgentId$1 } from "./session-key-IUFoWh21.js";
...
import { s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName } from "./streaming-Cv1vioSk.js";
...
import { E as toInboundMediaFacts, y as buildChannelInboundEventContext } from "./kernel-0wodWEMJ.js";
...
import { _ as requestFeishuApi, d as extractReplyText, g as readString, h as parseCommentContentElements, l as resolveFeishuRuntimeAccount, m as normalizeString, p as isRecord$1, s as resolveFeishuAccount, u as encodeQuery, v as buildFeishuCommentTarget, y as normalizeCommentFileType } from "./accounts-DYW6tCDc.js";
import { i as resolveReceiveIdType } from "./targets-B9vkkHUB.js";
import { c as decodeFeishuCardAction, o as buildFeishuCardActionTextFallback, s as createFeishuCardInteractionEnvelope } from "./send-result-D-3eKiJK.js";
import { t as buildFeishuConversationId } from "./conversation-id-BrnYeord.js";
import { a as resolveFeishuGroupConversationIngressAccess, c as resolveFeishuReplyPolicy, i as resolveFeishuGroupConfig, n as normalizeFeishuAllowEntry, o as resolveFeishuGroupSenderActivationIngressAccess, r as resolveFeishuDmIngressAccess, t as hasExplicitFeishuGroupConfig } from "./policy-t5VgKR90.js";
import { t as getFeishuRuntime } from "./runtime-BP4XWQ9i.js";
import { a as getFeishuUserAgent, i as createFeishuWSClient, n as createEventDispatcher, r as createFeishuClient } from "./client-Dhp8_L9b.js";
import { c as getChatInfo, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-CT1UasCs.js";
import { t as createFeishuThreadBindingManager } from "./thread-bindings-B_cJW9gF.js";
import "./runtime-api-BzJ8jHXn.js";
import { _ as normalizeFeishuExternalKey, a as sendCardFeishu, c as sendStructuredCardFeishu, d as isFeishuBroadcastMention, f as isMentionForwardRequest, g as shouldSuppressFeishuTextForVoiceMedia, h as sendMediaFeishu, i as resolveFeishuCardTemplate, l as parsePostContent, m as saveMessageResourceFeishu, n as getMessageFeishu, p as isFeishuGroupChatType, r as listFeishuThreadMessages, s as sendMessageFeishu, u as extractMentionTargets } from "./send-Bs7jQW6I.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-DK0IIsau.js";
import { a as clearFeishuBotIdentityState, c as httpServers, d as wsClients, f as fetchBotIdentityForMonitor, i as botOpenIds, l as recordWebhookStatus, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as closeTrackedFeishuHttpServer, r as botNames, s as feishuWebhookRateLimiter, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS, u as setFeishuBotIdentityState } from "./monitor.state-CkCz6oNB.js";
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-D3raYw13.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-D3raYw13.js");
