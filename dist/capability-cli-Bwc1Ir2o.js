...
import { _ as randomIdempotencyKey, c as callGateway } from "./call-BJmsXbuv.js";
...
import { c as loadAuthProfileStoreForRuntime, m as updateAuthProfileStoreWithLock } from "./store-Cj0cmDZP.js";
import { E as listMemoryEmbeddingProviders } from "./registry-CwedN2iD.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-BZF3xopk.js";
import "./auth-profiles-fyjB8pQd.js";
import { n as listProfilesForProvider } from "./profile-list-DZ2lnUWn.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-DaIgdnQt.js";
import { n as loadModelCatalog } from "./model-catalog-BgpfAkG5.js";
import { l as getImageMetadata, s as convertHeicToJpeg } from "./media-services-DnyDKtxe.js";
...
import { t as buildExplicitSessionIdSessionKey } from "./session-CUzhf826.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-DzYpjHMQ.js";
import { a as getCapabilityWebSearchCommandSecretTargets, c as getMemoryEmbeddingCommandSecretTargetIds, l as getModelsCommandSecretTargetIds, m as getTtsCommandSecretTargetIds, r as getCapabilityWebFetchCommandSecretTargets } from "./command-secret-targets-qH92jzOW.js";
...
import { o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-D8Yk7ZJc.js";
import { S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, d as listSpeechVoices, f as listTtsPersonas, g as resolveTtsConfig, k as textToSpeech, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, w as setTtsPersona } from "./tts-runtime-BJoFuQjA.js";
import "./tts-PJvYdXwM.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-DMRr6i7E.js";
import { a as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-QdoghzRF.js";
import { n as listEmbeddingProviders } from "./embedding-provider-runtime-CaJTiObK.js";
import { t as resolveMemorySearchConfig } from "./memory-search-DYCEqw5s.js";
import { n as listWebFetchProviders, r as resolveWebFetchDefinition, t as isWebFetchProviderConfigured } from "./runtime-JHQKfE0-.js";
...
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-BdMRrObU.js";
import { t as createEmbeddingProvider } from "./memory-core-bundled-runtime-Wi8BdHHB.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-nIrQbgUG.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-BTyXH95S.js");
